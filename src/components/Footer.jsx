      ...
      <footer className="bg-zinc-900 border-t border-t-gray-700 font-[Roboto]">
        <div className="footer sm:footer-horizontal text-neutral-content items-center px-4 max-w-7xl mx-auto">
          <aside className="grid-flow-col items-center font-[Montserrat] py-5">
            ...
            <p className="text-lg">© {new Date().getFullYear()} Ashlee Zoe Gesite. All rights reserved</p>
          </aside>
          ...
          <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
            <ul className="flex flex-row">
              ...
              {/* Linkedin */}
              <li className="mx-4">
                <a href="https://www.linkedin.com/in/ash-gesite-25a28334b/" target="_blank" className="mx-3" title="Linkedin">
              ...
              {/* Github */}
              <li className="mx-4">
                <a href="https://github.com/ashdroidcmd" target="_blank" className="mx-3" title="Github">
                  <svg className="text-white w-8 h-8"
              ...
              {/* Portfolio Link */}
              <li className="mx-4">
                <a href="https://ash-portfoliov2.vercel.app/" target="_blank" className="mx-3" title="Portfolio">
                  <svg className="text-white w-8 h-8"
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418" />
                  </svg>
